...
* **Keyboard Shortcut (Manual Override):** Press **Ctrl+Shift+Q** (**Cmd+Shift+Q** on Mac) to manually flip the current state whenever you need to - it reverts automatically at the next scheduled change.
* **First-Run Walkthrough:** A short onboarding tour opens automatically on install, explaining the icon colors, the schedule, and the shortcut.
...
<img src="screenshot.png?v=7" width="50%" alt="Silence Hero Screenshot">
